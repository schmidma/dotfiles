...
_G.packer_plugins = {
  ...
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/home/schmidma/.local/share/nvim/site/pack/packer/start/lspsaga.nvim"
  },
  neogit = {
    loaded = true,
  ...
  ["nvim-compe"] = {
    ...
    after_files = { "/home/schmidma/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/home/schmidma/.local/share/nvim/site/pack/packer/start/vim-surround"
  },
  ["vim-vsnip"] = {
    config = { "\27LJ\1\2-\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\18plugins/vsnip\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[command! -nargs=* -range -bang -complete=file ISwapWith lua require("packer.load")({'iswap.nvim'}, { cmd = "ISwapWith", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]]
