...
return {
  ...
  },
  {
    ...
    keys = {
      { keys.buffer.close, function() require("mini.bufremove").delete(0, false) end, desc = "Delete Buffer" },
      { keys.buffer.close_force, function() require("mini.bufremove").delete(0, true) end, desc = "Delete Buffer (Force)" },
    },
  },
